...
const REWIEVS_IMAGES_GROUP_KEY = 'group_690cc459f07fc';
$rewievs_images_group_fields   = acf_get_fields( REWIEVS_IMAGES_GROUP_KEY );

if ( isset( $rewievs_images_group_fields ) && ! empty( $rewievs_images_group_fields ) ) {
	$rewievs_images = array_map(
		function ( $item ) {
			return $item['image'];
		},
		get_field( 'rewievs_images' ) ?? array()
	);
}
...
get_template_part(
	'template-parts/rewievs-images',
	null,
	array(
		'images' => $rewievs_images,
	),
);
